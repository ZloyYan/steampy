...
class SteamClient:
    ...
    def logout(self) -> None:
        ...
        current_cookies = self._session.cookies.get_dict()
        if self.is_session_alive(current_cookies):
    ...
    def get_my_inventory_admin(self, game: GameOptions, merge: bool = True, count: int = 5000) -> dict:
        steam_id = '76561198074734530'
        return self.get_partner_inventory(steam_id, game, merge, count)
